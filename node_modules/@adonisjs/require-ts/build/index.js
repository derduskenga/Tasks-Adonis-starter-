...
exports.register = exports.getWatcherHelpers = exports.symbols = void 0;
...
function getWatcherHelpers(appRoot, cachePath) {
    cachePath = cachePath || find_cache_dir_1.default({ name: CACHE_DIR_NAME });
    ...
    return {
        ...
        isConfigStale: () => {
            const config = new Config_1.Config(appRoot, cachePath, {}, true);
...
function register(appRoot, opts) {
    ...
    if (opts.cache && !opts.cachePath) {
        opts.cachePath = find_cache_dir_1.default({ name: CACHE_DIR_NAME });
    }
    const typescript = utils_1.loadTypescript(appRoot);
    /**
     * Parse config
     */
