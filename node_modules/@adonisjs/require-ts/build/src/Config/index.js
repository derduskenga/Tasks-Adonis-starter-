...
class Config {
    constructor(appRoot, cacheRoot, ts, usesCache = true) {
         ...
         * is "tsconfig.json"
         */
        this.configFilePath = path_1.join(this.appRoot, 'tsconfig.json');
        /**
    ...
    getConfigRawContents() {
        utils_1.debug('checking for tsconfig "%s"', this.configFilePath);
        try {
            return fs_extra_1.readFileSync(this.configFilePath, 'utf-8');
        }
        catch (error) {
    ...
    parseTsConfig() {
        let exception = null;
        utils_1.debug('parse tsconfig file');
        /**
